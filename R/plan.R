plan  <-  drake::drake_plan(
  ...
  ed_fig_3_pdf = make_fig_3_new_NP(file_out("output/figures/ed_fig_3.pdf"), 
                                   ...
                                   POM_genomes_selected_gam_w_highlat,
                                   POM_genomes_selected_gam),
  ed_fig_4_pdf = make_fig_3_NO3only(file_out("output/figures/ed_fig_4.pdf"), 
                                         fig_out_folder,
                                         mod_CNP_no_Nutlim$mod_CP,
                                         mod_CNP_no_Nutlim$mod_NP,
                                         mod_CNP_no_Nutlim$mod_CN,
                                         POM_genomes_selected_gam_w_highlat,
                                         POM_genomes_selected_gam),
  ed_fig_5_highlat_pdf = make_fig_2b_only(file_out("output/figures/ed_fig_5_highlat.pdf"), 
                                                     fig_out_folder,
                                                     CNP_highlat_ver1_gam_devexpl),  
  ed_fig_5_lowlat_pdf = make_fig_2b_only(file_out("output/figures/ed_fig_5_lowlat.pdf"), 
                                                    fig_out_folder,
  ...
  ed_fig_10_pdf =  make_fig_delcnp_driver(file_out("output/figures/ed_fig_10.pdf"),
					 fig_out_folder,
                                         ...
                                         colbarlimits = c(-6,6),
                                         NP = TRUE),
  sup_fig_1_pdf = make_map_ver1ver2(file_out("output/figures/sup_fig_1.pdf"),
                                    fig_out_folder,
  ...
  sup_fig_4_pdf = make_plot_model_cv_CNP(file_out("output/figures/sup_fig_4.pdf"),
                                                    fig_out_folder,
                                                    cv_cn,

plan  <-  drake::drake_plan(
  ...
  fig_3_pdf = make_fig_3_new(file_out("output/figures/fig_3.pdf"), 
                             ...
                             POM_genomes_selected_gam),
  fig_3_pdf_NP = make_fig_3_new_NP(file_out("output/figures/fig_3_NP.pdf"), 
                             fig_out_folder,
                             mod_CNP_no_Nutlim$mod_NP,
                             mod_NP,
                             POM_genomes_selected_gam_w_highlat,
                             POM_genomes_selected_gam),
  fig_3_pdf_NO3only = make_fig_3_NO3only(file_out("output/figures/fig_3_NO3.pdf"), 
                             fig_out_folder,
                             mod_CNP_no_Nutlim$mod_CP,
                             mod_CNP_no_Nutlim$mod_NP,
                             mod_CNP_no_Nutlim$mod_CN,
  ...
  sup_fig_cnpdev_ver1_highlat_pdf = make_fig_2b_only(file_out("output/figures/sup_fig_cnpdev_ver1_highlat.pdf"), 
                                 fig_out_folder,
                                 CNP_highlat_ver1_gam_devexpl),  
  sup_fig_cnpdev_ver1_lowlat_pdf = make_fig_2b_only(file_out("output/figures/sup_fig_cnpdev_ver1_lowlat.pdf"), 
                                fig_out_folder,

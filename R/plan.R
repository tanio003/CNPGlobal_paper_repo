plan  <-  drake::drake_plan(
  ...
  CNP_highlat_ver1_gam_devexpl = make_CNP_devexpl_highlat_ver1(POM_highlat_ver1_surface_binned_gam),
  CNP_lowlat_ver1_gam_devexpl = make_CNP_devexpl_lowlat(POM_lowlat_ver1_surface_binned_gam),
  CNP_highlat_ver1_gam_pval =  make_CNP_pval_highlat_ver1(POM_highlat_ver1_surface_binned_gam),
  ...
  ed_fig_3_pdf = make_fig_3_new_NP(file_out("output/figures/ed_fig_3.pdf"), 
                                   fig_out_folder,
                                   mod_CNP_no_Nutlim$mod_NP,
                                   mod_NP,
                                   POM_genomes_selected_gam_w_highlat,
                                   POM_genomes_selected_gam),
  ed_fig_4_pdf = make_ed_fig_6(file_out("output/figures/ed_fig_4.pdf"),
                               fig_out_folder,
                               sst_surf_historic,
                               sst_surf_SSP370,
                               nitrate_surf_historic,
  ...
  #                          colbarlimits = c(-6,6),
  #                          NP = TRUE),	  
  ed_fig_5_cp_pdf =  make_fig_delcnp_driver(file_out("output/figures/ed_fig_5_cp.pdf"),
                                         fig_out_folder,
                                         cesm_lonlat_info,
                                         CNP_gam_cesm,
                                         maintitle = "Delta C:P",
                                         ...
                                         colbarlimits = c(-30,30),
                                         NP = FALSE),	  
  ed_fig_5_np_pdf =  make_fig_delcnp_driver(file_out("output/figures/ed_fig_5_np.pdf"),
                                          fig_out_folder,
                                          cesm_lonlat_info,
                                          CNP_gam_cesm,
                                          maintitle = "Delta N:P",

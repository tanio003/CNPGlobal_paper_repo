  ...
  fig_3_pdf = make_fig_3(file_out("output/figures/fig_3.pdf"), 
			 fig_out_folder,
                        ...
                        mod_CNP_no_Nutlim$mod_NP,
                         ...
                         mod_CNP_Nutcline_Nutlim_mod$mod_CP_Nutcline_Nutlim_mod,
                         mod_CNP_Nutcline_Nutlim_mod$mod_NP_Nutcline_Nutlim_mod,
                         mod_CNP_Nutcline_Nutlim_mod$mod_CN_Nutcline_Nutlim_mod,

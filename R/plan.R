plan  <-  drake::drake_plan(
  ...
  POM_highlat_gam = POM_all_gam %>% sep_data_highlat(latitude = 40),
  POM_lowlat_gam = POM_genomes_selected_gam %>% sep_data_lowlat(latitude = 40),
  scaled.POM_highlat_corr = clean_data_for_corr(sep_data_highlat(POM_all, latitude = 40)),
  scaled.POM_lowlat_corr = clean_data_for_corr(sep_data_lowlat(POM_all, latitude = 40)),
  # CESM2-LENS Data--------------------------------------
